...
```python
vi ~/.bashrc
export nnUNet_raw="/home/taozhong/TIPs/TIPs-main/nnUNet_raw"  # raw_data_path
export nnUNet_preprocessed="/home/taozhong/TIPs/TIPs-main/nnUNet_preprocessed"  # preprocessed_data_path
export nnUNet_results="/home/taozhong/TIPs/TIPs-main/nnResults"  # models_path
source ~/.bashrc
```
